#
# Be sure to run `pod lib lint SMSymbolFont.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = "SMSymbolFont"
  s.version          = "0.1.0"
  s.summary          = "A short description of SMSymbolFont."
  s.description      = <<-DESC
                       An optional longer description of SMSymbolFont
